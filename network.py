...
class ResnetGenerator(nn.Module):
    def __init__(self,input_nc,output_nc,ngf=64,norm_layer=nn.BatchNorm2d,use_dropout=False,n_block=9,padding_type='reflect'):
        assert(n_block>=0)
...
class Down(nn.Module):
    def __init__(self,input_nc,output_nc,norm_layer,use_bias):
        ...
        self.down = nn.Sequential(nn.Conv2d(self.input_nc,self.output_nc,kernel_size=3,stride=2,padding=1,bias=self.use_bias),
